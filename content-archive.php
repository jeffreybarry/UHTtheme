...
<article id="post-<?php the_ID(); ?>" <?php post_class($post_css_classes); ?> data-cols="<?php echo get_theme_mod('portfolio_article_column', '4')?>">
	<div class="article-helper notloaded<?php echo $post_helper_css_classes; ?>">
		<?php if (is_home() || is_search() || is_archive() || is_tag()) : // Only display Excerpts for Search ?>
			...
			<div class="post-preview transition animation <?php echo $post_preview_animation; ?>"<?php if(get_theme_mod('portfolio_whole_overlay_clickable', '1') == '1') : ?> data-url="<?php $category_link; ?>"<?php endif; ?>>
				<?php get_template_part('content', 'header'); ?>
			
				<div class="entry-summary">
					<a href="<?php $category_link; ?>" rel="bookmark"><?php category_description(); ?></a>
				</div><!-- .entry-summary -->
			</div>
			<?php else : ?>
