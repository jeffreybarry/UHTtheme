...
function theme_styles() {
		...
		wp_enqueue_style( 'bootstrap_css', get_template_directory_uri() . '/bootstrap/css/bootstrap.css', array(),filemtime( get_stylesheet_directory() .'/bootstrap/css/bootstrap.css') );
